...
<table width="100%" cellspacing="0" cellpadding="0" class="SearchLine">
	...
	<td>
		...
		<tr align="right" valign="middle">
		    <td colspan="3" align="left" class="Row2"><b>There are no products included in this appointment.</b></td>
		</tr>
	    </table>
	    <% } else { %>
	    <table width="100%" cellspacing="1" cellpadding="4" border="0">
		...
		<tr align="right" valign="middle">
		    ...
		    <td nowrap="nowrap" class="Row7"><b><div id="sub_total_product_<%=CoreTools.display(pb.getProductNo())%>"><%=CoreTools.displayPrice (pb.getPrice ())%></div></b></td>
