...
<table width="100%" cellspacing="0" cellpadding="0" class="SearchLine">
    ...
    <tr>
        <td>
		    ...
		    <td nowrap="nowrap" class="Row7"><b><div id="sub_total_service_<%=ServletHelper.display(service.getServiceNo())%>"><%=ServletHelper.displayPrice (service.getPrice ())%></div></b></td>
