...
<table width="100%" cellspacing="0" cellpadding="0" class="SearchLine">
	...
	<td>
		...
		<tr align="right" valign="middle">
		    ...
		    <td nowrap="nowrap" class="Row7"><input type="text" size="4" id="sr_<%=ServletHelper.display(pb.getProductNo())%>" value="<%=ServletHelper.display(searchResults.get (pb))%>" style="text-align:right" /></td>
