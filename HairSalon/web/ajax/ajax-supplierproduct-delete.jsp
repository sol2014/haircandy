...
<table width="100%" cellspacing="0" cellpadding="0" class="SearchLine">
    ...
    <tr>
	    ...
	    <table width="100%" cellspacing="1" cellpadding="4" border="0">
		    ...
		    <td align="left" valign="top" nowrap="nowrap" class="Row7"><%=ServletHelper.display (pb.getBrand())%></td>
		    <td align="left" valign="top" nowrap="nowrap" class="Row7"><%=ServletHelper.display (pb.getType())%></td>
                    <td nowrap="nowrap" valign="top" class="Row7"><img style="cursor:pointer" src="images/icons/small/remove_white.gif" id="<%=ServletHelper.display(pb.getProductNo())%>" onclick="deleteProduct('<%=ServletHelper.display(pb.getProductNo())%>')" title="Delete product from the list." /></td>
                </tr>
                <% }%>
            </table>
	    <% } %>
