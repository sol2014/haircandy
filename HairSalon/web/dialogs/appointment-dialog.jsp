...
<font face="Trebuchet MS" size="2">
    <div id="appointment_dialog_shell" class="DialogBox" style="width: 700px;height: 375px;"></div>
...
<script>
    ...
    document.getElementById("appointment_dialog_shell").style.top = (getScreenHeight() / 2) - 182 + "px";
</script>
