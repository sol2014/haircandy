<div id="employee_exception_dialog" class="DialogBox" style="width: 250px;height: 125px;">
    <table bgcolor="#FFFFFF" height="125" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td align="center" width="100%" background="images/scheduler/scheduler_topheader.gif"><b><font color="#FFFFFF">Add Availability Exception</font></b></td>
                        ...
                        <td height="100%" valign="top">
                            <table border="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td align="left"><u><b>Availability Exception</b></u></td>
                                </tr>
                                <tr>
...
<script>
    document.getElementById("employee_exception_dialog").style.left = (getScreenWidth() / 2) - 125 + "px";
    document.getElementById("employee_exception_dialog").style.top = (getScreenHeight() / 2) - 63 + "px";
</script>