...
<div id="sale_product_dialog" class="DialogBox" style="width: 600px;height: 350px;">
...
<script>
    document.getElementById("sale_product_dialog").style.left = (getScreenWidth() / 2) - 300 + "px";
    document.getElementById("sale_product_dialog").style.top = (getScreenHeight() / 2) - 175 + "px";
</script>