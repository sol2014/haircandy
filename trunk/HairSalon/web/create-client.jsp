	...
	<table width="100%" border="0" cellspacing="10" cellpadding="0">
		...
		<td align="left" valign="top">
			...
			<tr>
			    ...
			    <% } %>
			    <td align="left"><input type="text" name="phone_number" id="phone_number" onkeypress="return isNumberTyped (event)" onKeyUp="return checkTelephone(this)" size="10" value="<%=ServletHelper.display (userSession.moveAttribute ("client_new_phone_number"))%>"></td>
			</tr>
			<tr>
