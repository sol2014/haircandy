<div id="employee_service_dialog" class="DialogBox" style="width: 600px;height: 350px;">
...
<script>
    document.getElementById("employee_service_dialog").style.left = (getScreenWidth() / 2) - 300 + "px";
    document.getElementById("employee_service_dialog").style.top = (getScreenHeight() / 2) - 175 + "px";
</script>