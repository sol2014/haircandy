...
<script>
    document.getElementById("sale_service_dialog").style.left = (getScreenWidth() / 2) - 300 + "px";
    document.getElementById("sale_service_dialog").style.top = (getScreenHeight() / 2) - 175 + "px";
</script>