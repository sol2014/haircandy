<div id="supplier_product_dialog" class="DialogBox" style="width: 600px;height: 350px;">
	...
	<tr>
		...
		<table height="100%" width="97%" border="0" cellspacing="5" cellpadding="0">
			...
			<td colspan="2">
				...
				<tr>
				    <td align="left" valign="top" width="100%">Click the add button beside the products you want to add. You can filter the search results if necessary. Click close when you are finished.</td>
				</tr>
			    </table> 
			</td>
		    </tr>
			...
			<td valign="top">
				...
				<tr>
				    ...
				    <td align="left"><select size="1" id="product_type"><%= ServletHelper.generateProductTypeOptions (null, true)%></select></td>
				</tr>
			    </table>
...
<script>
    document.getElementById("supplier_product_dialog").style.left = (getScreenWidth() / 2) - 300 + "px";
    document.getElementById("supplier_product_dialog").style.top = (getScreenHeight() / 2) - 175 + "px";
</script>