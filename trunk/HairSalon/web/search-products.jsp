			...
			<table width="100%" cellspacing="0" cellpadding="0" class="SearchLine">
				...
				<td>
					...
					<tr align="right" valign="middle">
					    ...
					    <td align="left" valign="top" class="Row2"><span class="SearchLink"><a href="product?product_action=Load&product_no=<%= product.getProductNo ()%>" class="SearchLink"><%= product.getName ()%></a></span></td>
